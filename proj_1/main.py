...
# load the datasets
dataset_rgb = gdal.Open(filename_rgb, gdal.GA_ReadOnly) 
dataset_green = gdal.Open(filename_green, gdal.GA_ReadOnly) 
dataset_nir = gdal.Open(filename_nir, gdal.GA_ReadOnly) 
